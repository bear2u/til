...
[Figure 4-1](https://www.safaribooksonline.com/library/view/mastering-ethereum/9781491971932/ch04.html#ecc-curve)is an example of an elliptic curve, similar to that used by Ethereum.
...
![](https://www.safaribooksonline.com/library/view/mastering-ethereum/9781491971932/assets/simple_elliptic_curve.png "ecc-curve")
...
![](https://www.safaribooksonline.com/library/view/mastering-ethereum/9781491971932/assets/eq_1.png "y squared equals left-parenthesis x cubed plus 7 right-parenthesis over left-parenthesis double-struck upper F Subscript p Baseline right-parenthesis")

or

![](https://www.safaribooksonline.com/library/view/mastering-ethereum/9781491971932/assets/eq_2.png "y squared mod p equals left-parenthesis x cubed plus 7 right-parenthesis mod p")

The_mod p_\(modulo prime number p\) indicates that this curve is over a finite field of prime order_p_, also written as![](https://www.safaribooksonline.com/library/view/mastering-ethereum/9781491971932/assets/eq_3.png "double-struck upper F Subscript p"), where p = 2256– 232– 29– 28– 27– 26– 24– 1, a very large prime number.

Because this curve is defined over a finite field of prime order instead of over the real numbers, it looks like a pattern of dots scattered in two dimensions, which makes it difficult to visualize. However, the math is identical to that of an elliptic curve over real numbers. As an example,[Figure 4-2](https://www.safaribooksonline.com/library/view/mastering-ethereum/9781491971932/ch04.html#ecc-over-F17-math)shows the same elliptic curve over a much smaller finite field of prime order 17, showing a pattern of dots on a grid. The`secp256k1`Ethereum elliptic curve can be thought of as a much more complex pattern of dots on an unfathomably large grid.

![](https://www.safaribooksonline.com/library/view/mastering-ethereum/9781491971932/assets/ec_over_small_prime_field.png "ecc-over-F17-math")
...
Same as the “Direct” encoding except that it is 31 characters long. This allows it to encode any Ethereum address, but makes it incompatible with IBAN field validation. Example:`XE18CHDJBPLTBCJ03FE9 O2NS0BPOJVQCU2P`\(35 characters long\)
