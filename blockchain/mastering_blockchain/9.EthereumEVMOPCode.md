...
This appendix is based on the consolidation work done by the people of[_https://github.com/trailofbits/evm-opcodes_](https://github.com/trailofbits/evm-opcodes)as a Reference for Ethereum VM \(EVM\) Opcodes and Instruction information with the following LICENSE[_https://github.com/trailofbits/evm-opcodes/blob/master/LICENSE_](https://github.com/trailofbits/evm-opcodes/blob/master/LICENSE).
...
Thanks again to[_https://github.com/trailofbits/evm-opcodes_](https://github.com/trailofbits/evm-opcodes)for their contribution.
